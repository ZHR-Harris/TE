# -*- coding: utf-8 -*-
"""
Created on Sun Dec  6 12:46:37 2020
...
def get_data():
    ...
    np.save('X_train_multiclass_shot.npy', X_train)
    np.save('y_train_multiclass_shot.npy', y_train)
    np.save('X_test_multiclass_shot.npy', X_test)
    np.save('y_test_multiclass_shot.npy', y_test)
